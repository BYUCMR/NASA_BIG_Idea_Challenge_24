...
void DCMotorControl::setControlRate(int NewControlRate)
{
   if (NewControlRate > 0)
   {
    ...
    //   _Ki *= ratio;
    //   _Kd /= ratio;
      _ControlRate_us = (unsigned long)NewControlRate;
   }
}

void DCMotorControl::setCurrentPositionTicks(int NewPositionTicks)
{
...
{
	_Ticks->write( NewPositionInches*_TicksPerInch );
}
...
void DCMotorControl::addToDesiredPositionTicks(int TicksToAdd)
{
...
void DCMotorControl::setDesiredPositionTicks(int NewPositionTicks)
{
...
void DCMotorControl::setDeadbandTicks(int DeadbandTicks)
{
	_DeadbandTicks = DeadbandTicks;
	_InnerDeadbandTicks = DeadbandTicks;
	_OuterDeadbandTicks = DeadbandTicks;
}
void DCMotorControl::setDeadbandTicks(int InnerDeadbandTicks, int OuterDeadbandTicks)
{
...
int DCMotorControl::getDesiredPositionTicks() {return _DesiredPositionTicks;}
float DCMotorControl::getDesiredPositionInches() {return _DesiredPositionTicks/_TicksPerInch;}
int DCMotorControl::getCurrentPositionTicks() {return _Ticks->read();}
...
int DCMotorControl::getMode(){ return  _CurrentState;}
...
int DCMotorControl::getControlRate(){ return  _ControlRate_us;}
int DCMotorControl::getDeadbandTicks(){ return  _DeadbandTicks;}
int DCMotorControl::getDeadbandDutyCycle(){ return  _DeadbandDutyCycle;}
