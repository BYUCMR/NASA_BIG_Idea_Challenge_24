...
d_space=2.5*in2m;
d_offset=7*in2m;
d_offset_normal=7*in2m; %The Offset to Move Normal to the plane of the tube
...
t=.001*in2m; %The thickness of the material
% G=  4.1e9/1000;
...
SAVEMOVIE=1;
if SAVEMOVIE==1
    v = VideoWriter('Rolling_Loads_OutofPlane');
