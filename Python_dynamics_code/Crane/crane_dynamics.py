...
class CraneDynamics:
    ...
    def f(self, state, tau = np.zeros((90))):
        ...
        Fs = np.zeros((84))
        Edges = np.array([[1,2], [2,3], [3,1], [5,4], [4,3], [3,5], [5,2],
                          [2,6], [6,5], [1,4], [4,6], [6,1], [8,7], [7,3],
                          [3,8], [8,5], [5,9], [9,8], [4,7], [7,9], [9,4],
                          [11,10], [10,2], [2,11], [11,3], [3,12], [12,11],
                            [1,10], [10,12], [12,1], [14,13], [13,2], [2,14],
                            [14,5], [5,15], [15,14], [3,13], [13,15], [15,3],
                            [17,16], [16,3], [3,17], [17,4], [4,18], [18,17],
                            [1,16], [16,18], [18,1], [20,19], [19,11], [11,20],
                            [20,12], [12,21], [21,20], [10,19], [19,21], [21,10],
                            [23,22], [22,14], [14,23], [23,15], [15,24], [24,23],
                            [13,22], [22,24], [24,13], [26,25], [25,8], [8,26],
                            [26,9], [9,27], [27,26], [7,25], [25,27], [27,7],
                            [29,28], [28,17], [17,29], [29,18], [18,30], [30,29],
                            [16,28], [28,30], [30,16]]) - 1 # Subtract 1 to get the correct indices for python
