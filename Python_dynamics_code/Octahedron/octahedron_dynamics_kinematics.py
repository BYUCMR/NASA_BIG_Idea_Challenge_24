...
with open('/Users/annieobryan/Desktop/NASA Big Idea Challenge/Integrated Kinematics and Dynamics/octahedron_positions.csv') as f:
    output = [float(s) for line in f.readlines() for s in line[:-1].split(',')]

kinematic_positions = np.array(output).reshape(1002,18)
