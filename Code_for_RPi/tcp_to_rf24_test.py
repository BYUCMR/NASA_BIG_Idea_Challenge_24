...
def master():
    """Transmits an array of data as received from MATLAB TCP Server"""
    ...
    while failures < 6:
        ...
        # "<h" means a little endian hexadecimal representation
        buffer = struct.pack("<f", payload[0])
        #buffer.append(struct.pack("<f", payload[1]))  
        start_timer = time.monotonic_ns()  # start timer
        radio.write(buffer) #TODO: Fix write flag error so it returns the correct value
        result=True # Current solution to write flag error
